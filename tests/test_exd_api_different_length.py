        ...
        with tempfile.TemporaryDirectory() as temporary_directory_name:
            ...
            with TdmsWriter(file_path) as tdms_writer:
                ...
                tdms_writer.write_segment([ChannelObject(
                    "group_1", "channel_3", np.array([3.1, 3.2, 3.3, 3.4], np.float64))])
                tdms_writer.write_segment([ChannelObject(
                    "group_1", "channel_4", np.array([4.1, 4.2, 4.3, 4.4], np.float64))])

                tdms_writer.write_segment([ChannelObject(
                    "group_2", "channel_1", np.array([1.1, 1.2, 1.3, 1.4], np.float64))])
                tdms_writer.write_segment([ChannelObject(
                    "group_2", "channel_2", np.array([2.1, 2.2, 2.3, 2.4], np.float64))])
                tdms_writer.write_segment(
                ...
                tdms_writer.write_segment([ChannelObject(
                    "group_3", "channel_1", np.array([1.1, 1.2, 1.3, 1.4], np.float64))])
                tdms_writer.write_segment(
                    [ChannelObject("group_3", "channel_2", np.array([2.1, 2.2], np.float64))])
                tdms_writer.write_segment([ChannelObject(
                    "group_3", "channel_3", np.array([3.1, 3.2, 3.3, 3.4], np.float64))])
                tdms_writer.write_segment(
                    [ChannelObject("group_3", "channel_4", np.array([4.1, 4.2], np.float64))])

                tdms_writer.write_segment([ChannelObject(
                    "group_4", "channel_1", np.array([1.1, 1.2, 1.3, 1.4], np.float64))])
                tdms_writer.write_segment([ChannelObject(
                    "group_4", "channel_2", np.array([2.1, 2.2, 2.3, 2.4], np.float64))])
                tdms_writer.write_segment([ChannelObject(
                    "group_4", "channel_3", np.array([3.1, 3.2, 3.3, 3.4], np.float64))])
                tdms_writer.write_segment([ChannelObject(
            ...
            try:
                ...
                self.assertSequenceEqual(
                    values.channels[1].values.double_array.values, [2.1, 2.2, 2.3, 2.4])
                self.assertSequenceEqual(
                    values.channels[2].values.double_array.values, [3.1, 3.2, 3.3, 3.4])
                self.assertSequenceEqual(
                    values.channels[3].values.double_array.values, [4.1, 4.2, 4.3, 4.4])
